...
import live.nerotv.npanel.Utils.Lag;
import live.nerotv.npanel.Utils.PasswordHash;
import live.nerotv.npanel.getters.*;
import live.nerotv.npanel.posters.*;
...
public class PanelPlugin extends JavaPlugin implements Listener {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (action.equalsIgnoreCase("ban")) {
                    Bukkit.dispatchCommand(Bukkit.getConsoleSender(),"ban "+name+" "+message);
                }
            }
        }.runTask(this);
